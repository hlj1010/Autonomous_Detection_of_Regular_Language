# Code from https://gist.githubusercontent.com/siemanko/b18ce332bde37e156034e5d3f60f8a23/raw/ac67994d1bdf11fde7444269152f7ae58c3ae241/tf_lstm.py
...
inputs = tf.placeholder(
    tf.float32, (None, None, INPUT_SIZE))  # (time, batch, in)
outputs = tf.placeholder(
    tf.float32, (None, None, OUTPUT_SIZE))  # (time, batch, out)
...
def final_projection(x): return layers.linear(
...
accuracy = tf.reduce_mean(
    tf.cast(tf.abs(outputs - predicted_outputs) < 0.5, tf.float32))
